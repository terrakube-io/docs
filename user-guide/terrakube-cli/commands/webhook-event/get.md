# `terrakube webhook-event get`

Retrieves details of a webhook event rule.

## Usage

```bash
terrakube webhook-event get --organization <ORG_NAME_OR_ID> --workspace <WORKSPACE_NAME_OR_ID> --webhook-id <WEBHOOK_ID> --id <EVENT_ID> [flags]
```
